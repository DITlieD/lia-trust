...
use crate::contracts::{
    ...
    ALL_CAPABILITY_KEYS, CAP_COMPLETION_GATE, CAP_CREDENTIAL_BROKER, CAP_IMMUTABLE_JOURNAL,
    CAP_NETWORK_CONTROL, CAP_OFFLINE_VERIFICATION, CAP_POST_WRITE_RECEIPT, CAP_PRE_WRITE_BLOCK,
